<div class="page-header">
  <div class="row align-items-center mb-3">
    <div class="col-sm mb-2 mb-sm-0">
      ...
      <h1 class="page-header-title">Staffs<span class="badge badge-soft-dark ml-2"><?php echo mysqli_num_rows($data["staffs"]) ?></span></h1>
    </div>
...
<div class="card">
  <div class="table-responsive">
    <table class="table table-borderless card-table">
      ...
      <tbody>
        <?php
        while ($row = mysqli_fetch_array($data["staffs"])) {
        ?>
          <tr>
